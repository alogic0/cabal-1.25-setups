...
import Distribution.Package ( unPackageName, PackageId, InstalledPackageId, packageVersion, packageName, Package(..) )
...
generateBuildModule verbosity pkg lbi = do
  ...
  where
    ...
    formatone p = 
      let n = unPackageName (packageName p)
      in
      n ++ "-" ++ show (packageVersion p)
